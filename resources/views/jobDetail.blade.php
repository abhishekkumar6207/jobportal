                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class=" rounded-3 p-3">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="{{ url('/findJobs') }}"><i class="fa fa-arrow-left"
                            ...
                            <div class="single_jobs white-bg d-flex justify-content-between">
                                ...
                                <div class="jobs_right">
                                    <div class="apply_now {{ $count == 1 ? 'save-job' : '' }}">
                                        <a class="heart_mark" href="javascript:voild(0);"
                        ...
                        <div class="descript_wrap white-bg">
                            ...
                            @if (!empty($jobDetail->description))
                                <div class="single_wrap">
                                    ...
                                    {{ strip_tags($jobDetail->description) }}
                                </div>
                            @endif
                            ...
                            @if (!empty($jobDetail->responsibility))
                                <div class="single_wrap">
                                    ...
                                    <ul>
                                        {{ strip_tags($jobDetail->responsibility) }}
                                    </ul>
                                </div>
                            @endif
                            ...
                            @if (!empty($jobDetail->qualifications))
                                <div class="single_wrap">
                                    ...
                                    <ul>
                                        {{ strip_tags($jobDetail->qualifications) }}
                                    </ul>
                                </div>
                            @endif
                                ...
                                <table class="table table-striped">
                                    ...
                                    @if ($JobApplication->isNotEmpty())
                                        @foreach ($JobApplication as $JobApplications)
                                            <tr>
                                                <th>{{ $JobApplications->user->name }}</th>
                                                <th>{{ $JobApplications->user->email }}</th>
                                                <th>{{ $JobApplications->user->mobile }}</th>
                                                <th>{{ \carbon\carbon::parse($JobApplications->applied_date)->format('d M,Y ') }}
                                                </th>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
                                            <td colspan="Applicant"></td>
                                        </tr>
                                    @endif
                        ...
                        <div class="job_sumary">
                            ...
                            <div class="job_content pt-3">
                                <ul>
                                    ...
                                    @if (!empty($jobDetail->company_name))
